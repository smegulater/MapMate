...
namespace MapMate
{
    ...
    internal class MapMate : BaseUnityPlugin
    {
        public const string PluginGUID = "com.smegulater.MapMate";
        public const string PluginName = "Map Mate";
        ...
        private void FejdStartup_Awake(On.FejdStartup.orig_Awake orig, FejdStartup self)
        {
            ...
            //Jotunn.Logger.LogInfo("FejdStartup has landed");
        }
    }
}